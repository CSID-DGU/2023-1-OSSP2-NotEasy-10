...
### 소개: 
> 저희 팀은 **수 많은 칵테일을 카테고리로 분류**하자는 의미를 가진 **칵테고라이즈** 웹사이트를 제작하기로 기획하였습니다. **태그를 활용**하여 사용자의 선호도에 따라 다양한 칵테일 종류들을 추천해주고, 칵테일에 관심이 있는 사람들과 소통할 수 있는 커뮤니티를 제작함으로써, 재료들을 활용해 칵테일을 만들 수 있는 방법이나 솔루션을 공유 할 수 있는 웹사이트를 제작해보았습니다.
...
### 주요 기능:
1) 날씨를 반영한 칵테일 추천
2) 칵테일 검색을 위한 다양한 태그 제공
3) 선호 태그를 기반으로 사용자의 취향을 반영한 칵테일 추천
4) 정보 공유를 위한 커뮤니티 제공
...
> 현재 사용자 위치의 날씨에 기반하여 칵테일을 추천, 또한 사용자가 선택한 선호 태그를 기반으로 칵테일을 추천
<br/>
...
> 재료, 주스, Bitter, 우유, 시럽, 술, 색깔, 맛, 날씨, 기타와 같이 카테고리화된 태그들을 선택해 칵테일 검색
<br/>

**[3] 칵테일 상세페이지 -** 
<img width="1419" alt="스크린샷 2023-06-18 오후 2 46 47" src="https://github.com/CSID-DGU/2023-1-OSSP2-NotEasy-10/assets/114224596/931a5145-56ec-4770-9d31-87d76eb54fe7">
> 칵테일 레시피, 재료, 도수, 사용잔의 정보를 제공, TTS 기능을 통한 레시피 읽어주기 기능, 좋아요 기능, 현재 칵테일과 유사한 칵테일을 추천해주는 기능
<br/>
...
> 사용자가 좋아요를 누른 칵테일과 게시글을 한 눈에 볼 수 있는 좋아요 페이지
---
<br/>

## 3. 프로젝트 시스템 구조
![IMG_4749](https://github.com/CSID-DGU/2023-1-OSSP2-NotEasy-10/assets/114224596/0d95c746-8f31-40c0-892e-f85ccd32fd45)

---
<br/>

## 4. 칵테일 유사도 측정 기준
<img width="957" alt="스크린샷 2023-06-18 오후 3 08 00" src="https://github.com/CSID-DGU/2023-1-OSSP2-NotEasy-10/assets/114224596/c8a761c7-6799-43ba-b85a-18794c301806">

> 칵테일 상세 페이지에서 사용자가 보고 있는 칵테일과 유사한 칵테일을 추천해주기 위해, 각 태그에 가중치를 두어 위 기준표에 따라 태그 가중치를 계산하고, 가장 점수가 높은 칵테일을 찾아 해당 칵테일을 유사한 칵테일로 추천한다.
---
